        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <NavLink className="navbar-brand" aria-current="page" exact="true" to="/privado">TrabalhoLPE1</NavLink>
                            ...
                            {usuario &&
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><NavLink className="dropdown-item" exact="true" to="pais">Pais</NavLink></li>
                                        <li><NavLink className="dropdown-item" exact="true" to="estados">Estados</NavLink></li>
                                        <li><NavLink className="dropdown-item" exact="true" to="cidades">Cidades</NavLink></li>
